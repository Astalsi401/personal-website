...
/*另一段Stata code....*/
<</dd_do>>
~~~~`,lang:"md"}),e.jsxs("p",{children:["以",e.jsx("code",{children:"dyndoc 檔名.do, replace"}),"將檔案與執行結果輸出為html，輸出檔案如下："]}),e.jsx(r,{src:"/personal-website/assets/demo-files/stata/other_02-html/example1.html"})]})},{title:"webdoc",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("code",{children:"webdoc"}),"的do檔案看起來如下："]}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"head()"}),"代表html中<head>標籤內的資訊"]}),e.jsxs("li",{children:[e.jsx("code",{children:"w(800px)"}),":頁面寬度800px"]}),e.jsxs("li",{children:[e.jsx("code",{children:'t("example2")'}),":html頁面的名稱，不需要跟檔名相同"]}),e.jsxs("li",{children:[e.jsx("code",{children:"st(ocean cbf)"}),":主題為ocean（海藍色），cbf代表Stata輸入指令為粗體字"]})]}),e.jsx(i,{code:`clear

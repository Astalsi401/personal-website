...
export const Sections: SectionsProps = ({ imagePath, demoPath }) => [
  {
    ...
    content: (
      <>
        <Subsection>
          <SubsectionTitle>方法一：使用矩陣格式的資料</SubsectionTitle>
          <P>
            資料分為兩個部分：
            <br />
        ...
        <Subsection>
          <SubsectionTitle>方法二：使用Edgelist格式的資料繪製網絡圖</SubsectionTitle>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <Subsection>
          <SubsectionTitle>以grade分類</SubsectionTitle>
        ...
        <Subsection>
          <SubsectionTitle>以gender分類</SubsectionTitle>

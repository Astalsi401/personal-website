...
const Sections = (demoPath) => [
  {
    ...
    content: (
      <>
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor02.svg`} alt="" />
        <p>
          上式中分母部分為X與Y之變異數，而分子部分的<i>Cov(X,Y)</i> 為共變量。我們可以將上述公式推衍為下式：
        </p>
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor03.svg`} alt="" />
        <p>
          在上式中，
          <img className="img-invert" src={`${import.meta.env.BASE_URL}/assets/images/cor04.svg`} alt="" />
          實為X的標準差，即
          <i>
            S<sub>X</sub>
          </i>
        ...
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor05.svg`} alt="" />
        <p>前面的式子再推衍之，我們得到下式：</p>
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor06.svg`} alt="" />
        <p>
          將分子部分的(<i>n</i>-1)<sup>2</sup>移到根號外，得到下式：
        </p>
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor07.svg`} alt="" />
        <p>
          抵消分母和分子的<i>n</i>-1後，得到相關係數公式：
        </p>
        <img className="img-invert d-block my-2 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor08.svg`} alt="" />
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/cor01.png`} />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <div className="my-2">
          ...
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/sca02.png`} />
        </div>
      </>
    ),
  },

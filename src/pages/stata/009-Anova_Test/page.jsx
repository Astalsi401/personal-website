      ...
      <>
        ...
        <div className="my-2">
          ...
          <CodeChunk
            ...
            lang="output"
          />
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/anova01.png`} />
        </div>
      </>
    ),
  },
      ...
      <>
        ...
        <div className="my-2">
          ...
          <CodeChunk
            ...
            lang="output"
          />
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${import.meta.env.BASE_URL}/assets/images/twoway-anova07.png`} />
        </div>
      </>
    ),
  },

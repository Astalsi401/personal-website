...
export const Sections: SectionsProps = ({ imagePath }) => [
  {
    ...
    content: (
      <>
        ...
        <Subsection>
          <SubsectionTitle>範例2：姓名的性別感覺在求職是否有影響？</SubsectionTitle>
          <CodeChunk code={`set more off\nclear\n\ninput type interest\n1 6\n1 7\n1 8\n1 6\n1 4\n2 2\n2 5\n2 4\n2 3\n2 5\n3 3\n3 2\n3 4\n3 4\n3 3\nend\n\nlab var type "姓名性別感覺"\nlab def type 1 "男性" 2 "中性" 3 "女性"\nlab val type type\nlab var interest "感興趣程度"\npwmean interest, over(type) mcompare(tuk) effects`} lang="stata" />
          ...
          <CodeChunk
            ...
            lang="output"
          />
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${imagePath}/anova01.png`} />
        </Subsection>
      </>
    ),
  },
      ...
      <>
        <Subsection>
          <Ol>
            ...
            <Ol type="i">
              ...
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto img-invert" src={`${imagePath}/twoway-anova01.png`} />
              <Li>只有A因子有效應：</Li>
              <P>顯示在無論有沒有使用到B因子的情況下，若使用到A因子，則心率會從60bps增加到80bps。</P>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto img-invert" src={`${imagePath}/twoway-anova02.png`} />
              <Li>只有B因子有效應：</Li>
              <P>顯示在無論有沒有使用到A因子的情況下，若沒有使用到B因子，則心率會一直停留在60bps，但若使用了B因子時，則⼼率增加到70bps。</P>
              <ZoomImage className="w-lg-50 w-sm-75 mx-auto img-invert" src={`${imagePath}/twoway-anova03.png`} />
        ...
        <Subsection>
          ...
          <CodeChunk
            ...
            lang="output"
          />
          <ZoomImage className="w-lg-50 w-sm-75 mx-auto" src={`${imagePath}/twoway-anova07.png`} />
        </Subsection>
      </>
    ),
  },

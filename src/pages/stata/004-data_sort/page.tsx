  ...
  },
  {
    ...
    content: (
      <>
        ...
        <P>
          以表格呈現資料中的學歷變項（<InlineCode>v11</InlineCode>）。
        </P>
        ...
        <Ul>
          <Li>
            <P>
              <b>
                <InlineCode>describe varname</InlineCode>
              </b>
            </P>
          </Li>
          <Li>
            <P>
              <b>
                <InlineCode>tabulate varname</InlineCode>
              </b>
            </P>
            ...
            />
            <P>
              從<InlineCode>d v11</InlineCode>這個指令可以知道v11的value label是V11
            </P>
          </Li>
          <Li>
            <P>
              <b>
                <InlineCode>numlabel varname, add</InlineCode>
              </b>
            </P>
            <P>
              利用<InlineCode>numlabel V11, add</InlineCode>可以檢視各個選項的編號。
            </P>
            <P>
              <InlineCode>numlabel _all, add</InlineCode>可以一次處理所有變項，但資料較大時可能要等它運行幾秒鐘。
            </P>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <P>
          若codebook中已經標明遺漏值（通常為999），那也可以使用<InlineCode>mvdecode _all, mv(999)</InlineCode>來一次定義資料中所有變項的遺漏值，不過視需求而定，某些變項有可能需要個別調整。
        </P>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <Subsection>
          <SubsectionTitle>
            第一種方式：<InlineCode>recode</InlineCode>
          </SubsectionTitle>
          <P>
            <InlineCode>recode</InlineCode>是針對單一變項重新編碼，指令較簡短，常常會遇到有些資料需要進行反項編碼才能讓人更容易理解，此時適合使用這種方式。
          </P>
        ...
        <Subsection>
          <SubsectionTitle>
            第二種方式：<InlineCode>replace</InlineCode>
          </SubsectionTitle>
          <P>
            <InlineCode>replace</InlineCode>是一一指定新變項中obs的條件，雖然較繁複，但好處是可以將多個變項中的obs整合進同一個變項中。
          </P>
  ...
  },
  {
    ...
    content: (
      <>
        <Subsection>
          <P>
            <a href="https://www.jstor.org/stable/589632?seq=1" target="_blank">
              EGP Class Scheme
            </a>
            是一種職業地位的分類方法，在STATA中可以利用<InlineCode>iscoegp</InlineCode>進行分類。
          </P>
          <P>
            以<InlineCode>iscoegp</InlineCode>計算職業地位需要先獲取以下資訊：
          </P>
          <Ol>
        ...
        <Subsection>
          <SubsectionTitle>是否受雇</SubsectionTitle>
        ...
        <Subsection>
          <SubsectionTitle>工作單位規模</SubsectionTitle>
        ...
        <Subsection>
          <SubsectionTitle>計算社經地位</SubsectionTitle>
        ...
        <Subsection>
          <SubsectionTitle>定義遺漏值</SubsectionTitle>
        ...
        <Subsection>
          <SubsectionTitle>職業分類建立完成</SubsectionTitle>
  ...
  },
  {
    ...
    content: (
      <>
        <Ol>
          <Li>
            <InlineCode>egen miny = min(y), by(x)</InlineCode>：
          </Li>
          <P>
            依據變項<InlineCode>x</InlineCode>分類建立最小值，命名為<InlineCode>miny</InlineCode>。
          </P>
          <Li>
            <InlineCode>by varname: g count = _N</InlineCode>：
          </Li>
          <P>計算重複變項的數量。</P>
          <Li>
            <InlineCode>by varname: g count = _n</InlineCode>：
          ...
          <P>為重複變項編號。</P>
          <Li>
            <InlineCode>nrow</InlineCode>
          </Li>
          <P>將第一列作為變項名稱</P>
          <Li>
            <InlineCode>replace x = subinstr(x, ",", "", .)</InlineCode>
          </Li>
          <P>將變項x中的逗號替換掉</P>
          <Li>
            <InlineCode>g y = "a" if strmatch(x, "*a*")</InlineCode>
          </Li>
          <P>
            如果<InlineCode>x</InlineCode>包含字母"a"，建立變項<InlineCode>y = "a"</InlineCode>
          </P>
          <Li>
            <InlineCode>g y = usubstr("abcde", 2, 2)</InlineCode>
          </Li>
          <P>
            從字串<InlineCode>abcde</InlineCode>的第2個字開始，往後數2個字母，建立<InlineCode>y</InlineCode>變項，在本範例中<InlineCode>y = "bc"</InlineCode>
          </P>
          <Li>
            <InlineCode>preserve</InlineCode>、<InlineCode>restore</InlineCode>
          </Li>
          <P>建立還原點、回到還原點</P>
          <Li>
            <InlineCode>split strvar, p("/") g(a)</InlineCode>
          </Li>
          <P>
            依據字符<InlineCode>/</InlineCode>分割文字變項<InlineCode>strvar</InlineCode>為<InlineCode>a1</InlineCode>、<InlineCode>a2</InlineCode>、<InlineCode>a3</InlineCode>...
          </P>
          <Li>
            <InlineCode>char(10)</InlineCode>
          </Li>
          <P>ASCII編碼中的換行符，可插入字串中</P>
          <Li>
            stata if/else用法，<InlineCode>var</InlineCode> = 變項名稱
          </Li>
        </Ol>
